...
class MFCOrdersApp {
    ...
    editProduct(productId) {
        ...
        // Change modal title and store ID for editing
...
My Father Cigars Southeast`;
    ...
    renderCustomerHistory(orders) {
        ...
        container.innerHTML = `
            ...
            <div style="margin-bottom: 2rem;">
                <div style="background: #f5f5f5; padding: 1rem 1.5rem; border-radius: 8px; cursor: pointer; display: flex; justify-content: space-between; align-items: center; border: 2px solid #e0e0e0;" onclick="app.toggleOrderHistory()">
                    <h4 style="margin: 0; color: var(--secondary);">📋 Order History (${orders.length} orders - chronological)</h4>
                    <span id="orderHistoryToggle" style="font-size: 1.5rem; color: var(--secondary);">▼</span>
                </div>
                <div id="orderHistoryContent" style="display: none; margin-top: 1rem;">
    ...
    renderTop10Analysis() {
        ...
        const colors = {
            ...
            AL: { bg: '#2563eb', text: 'white', light: '#3b82f6' },
            GA: { bg: '#16a34a', text: 'white', light: '#22c55e' },
            TN: { bg: '#dc2626', text: 'white', light: '#ef4444' },
            MS: { bg: '#9333ea', text: 'white', light: '#a855f7' },
