...
function loadData() {
    ...
    // Load customers (from mfc-data.js - uses CUSTOMER_DATA variable)
    AppState.customers = typeof CUSTOMER_DATA !== 'undefined' ? CUSTOMER_DATA : generateSampleCustomers();
    
    // Load products (from mfc-data.js - uses PRODUCT_DATA variable)
    AppState.products = typeof PRODUCT_DATA !== 'undefined' ? PRODUCT_DATA : generateSampleProducts();
