...
class MFCOrdersApp {
    ...
    initEventListeners() {
        ...
        // Reports
        document.getElementById('downloadAllOrdersCSV').addEventListener('click', () => this.downloadAllOrdersCSV());
        document.getElementById('downloadAllOrdersJSON').addEventListener('click', () => this.downloadAllOrdersJSON());
    ...
    renderMonthlyOrders() {
        ...
        if (this.orders.length === 0) {
            container.innerHTML = '<p style="color: var(--text-secondary); padding: 2rem; text-align: center;">No orders to display. Create your first order!</p>';
            return;
        }
                                ...
                                ${orders.map(order => `
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <button class="btn btn-small" onclick="app.viewOrderDetails(${order.id})">View</button>
                                        </td>
                                    </tr>
                                `).join('')}
                            </tbody>
